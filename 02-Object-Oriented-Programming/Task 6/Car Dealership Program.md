Develop a console application that simulates a car dealership management system. This system will manage different types of cars, including electric and fuel-based cars, allowing for inventory tracking, car details updates, and handling of customer inquiries.

**Core Features & Tasks**:

1. **Inventory Management**
    - **Concepts Used**: Classes, Objects, Inheritance, Encapsulation.
    - **Task**: Implement a `Dealership` class that manages an inventory of cars, including both `Car` and `ElectricCar` objects. Use a collection to store these objects.
2. **Car Details Modification**
    - **Concepts Used**: Properties, Methods.
    - **Task**: Create methods within the `Dealership` class to add, remove, and update car information in the inventory.
3. **Displaying Car Information**
    - **Concepts Used**: Polymorphism, Inheritance.
    - **Task**: Implement a method to display the details of each car. The details should differ slightly between `Car` and `ElectricCar` objects, showcasing polymorphism.
4. **Search Functionality**
    - **Concepts Used**: Encapsulation, Properties.
    - **Task**: Implement a search feature that lets the user find a car by make, model, or year.
